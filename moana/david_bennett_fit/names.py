...
class NameEnum(NameEnumBase):
    ...
    PI_ER = NameElement(name='pi_er', david_bennett_name='piEr', latex_string=r'\pi_{E_{r}}')
    PI_ETH = NameElement(name='pi_eth', david_bennett_name='pieth', latex_string=r'\pi_{E_{\theta}}')
